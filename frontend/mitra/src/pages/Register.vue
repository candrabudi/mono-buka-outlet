            ...
            <form @submit.prevent="handleRegister">
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  ...
                  <input id="name" v-model="form.name" type="text" placeholder="Nama lengkap Anda" required />
                </div>
              </div>
              ...
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  ...
                  <input id="email" v-model="form.email" type="email" placeholder="mitra@email.com" required />
                </div>
              </div>
              ...
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  ...
                  <input id="phone" v-model="form.phone" type="text" placeholder="08xxxxxxxxxx" />
                </div>
              </div>
              ...
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  ...
                  <input id="password" v-model="form.password" :type="showPw ? 'text' : 'password'" placeholder="Minimal 6 karakter" required minlength="6" />
...
.login-form-wrapper { max-width: 450px; margin: auto; padding: 40px 0; width: 100%; }
